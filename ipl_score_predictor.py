...
#SET PAGE WIDE
st.set_page_config(page_title='IPL_TotalScore_Predictor',layout="centered")
...
st.markdown("<h1 style='text-align: center; color: dark;'> IPL Score Predictor 2022 </h1>", unsafe_allow_html=True)
...
st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("aksh-yadav-bY4cqxp7vos-unsplash.jpg");
...
with st.expander("Description"):
    st.info("""A Simple ML Model to predict IPL Total Scores between teams in an ongoing match. To make sure the model results accurate score and some reliability the minimum no. of current overs considered is greater than 5 overs.
...
batting_team= st.selectbox('Select the Batting Team ',('Kolkata Knight Riders' ,'Chennai Super Kings', 'Rajasthan Royals','Mumbai Indians' ,'Deccan Chargers','Kings XI Punjab','Royal Challengers Bangalore','Delhi Daredevils','Pune Warriors','Sunrisers Hyderabad'))
...
bowling_team = st.selectbox('Select the Bowling Team ',('Kolkata Knight Riders','Chennai Super Kings','Rajasthan Royals','Mumbai Indians','Deccan Chargers','Kings XI Punjab','Royal Challengers Bangalore','Delhi Daredevils','Pune Warriors','Sunrisers Hyderabad'))
